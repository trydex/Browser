...
namespace Browser.Controls.Handlers
{
    ...
    public class RequestHandler : IRequestHandler
    {
        ...
        public ProxyInfo InstanceProxy { get; set; }
            ...
            IRequestCallback callback)
        {
            ...
            {
                request.SetReferrer(Referer, ReferrerPolicy.Default);
            }
            ...
            string realm, string scheme, IAuthCallback callback)
        {
            if (isProxy)
            {
                callback.Continue(InstanceProxy.Username, InstanceProxy.Password);
                return true;
            }
